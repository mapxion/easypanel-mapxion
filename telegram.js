...
(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .xptg-community-btn{color:#5d842b!important;border-color:rgba(122,171,57,.32)!important;background:rgba(122,171,57,.06)!important}
      .xptg-community-btn:hover{background:rgba(122,171,57,.12)!important}
      ...
      .xptg-community{margin-top:15px;padding:16px;border:1px solid rgba(122,171,57,.26);border-radius:17px;background:rgba(122,171,57,.055)}
      .xptg-community-head{display:flex;align-items:flex-start;gap:12px}
      .xptg-community-icon{width:44px;height:44px;flex:0 0 44px;display:grid;place-items:center;border-radius:50%;background:rgba(122,171,57,.13);font-size:22px}
      .xptg-community-title{font-size:15px;font-weight:900;color:var(--text)}
      .xptg-community-text{margin-top:4px;color:var(--muted);font-size:12px;line-height:1.5}
      .xptg-community-tags{display:flex;flex-wrap:wrap;gap:6px;margin-top:12px}
      .xptg-community-tag{display:inline-flex;align-items:center;min-height:25px;padding:0 9px;border-radius:999px;background:#fff;border:1px solid rgba(122,171,57,.25);color:#5d842b;font-size:10px;font-weight:900}
      .xptg-community-link{display:inline-flex;align-items:center;justify-content:center;margin-top:13px;min-height:40px;padding:0 14px;border-radius:12px;background:#fff;border:1px solid rgba(122,171,57,.34);color:#5d842b;text-decoration:none;font-size:13px;font-weight:900}
  ...
  function communitySectionHtml() {
    return `
      <div class="xptg-community">
        <div class="xptg-community-head">
          <div class="xptg-community-icon">👥</div>
          <div>
            <div class="xptg-community-title">Comunidad XProces</div>
            <div class="xptg-community-text">Espacio de usuarios y administradores para ayuda, sugerencias, drones, toma de datos, fotogrametría, procesado y resultados.</div>
          </div>
        </div>
        <div class="xptg-community-tags">
          <span class="xptg-community-tag">Ayuda</span>
          <span class="xptg-community-tag">Sugerencias</span>
          <span class="xptg-community-tag">Drones</span>
          <span class="xptg-community-tag">Toma de datos</span>
          <span class="xptg-community-tag">Procesado</span>
          <span class="xptg-community-tag">LAS · Orto · DSM · DTM · 3D</span>
        </div>
        <a class="xptg-community-link" href="${COMMUNITY_URL}" target="_blank" rel="noopener noreferrer">Unirme a la comunidad XProces</a>
      </div>`;
  }
  ...
  function injectCommunityButton() {
    ...
    button.className = "btn btn-secondary xptg-community-btn";
    ...
    actions.insertBefore(button, login || actions.firstChild);
  }
